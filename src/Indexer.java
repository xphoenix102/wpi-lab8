...
public class Indexer
{
    ...
    private void indexDocuments()
    {
        ...
        try {
            writer = new IndexWriter(FSDirectory.open(Paths.get(Constants.index_dir)),writerConfig);
    ...
    private Document getHTMLDocument(String path, int id)
    {
        ...
        */
        ...
        StoredField storedField = new StoredField("id",id);
        // ----------------------------------
        ...
        // ----------------------------------
       TextField textField = new TextField("content",getTextFromHTMLFile(file),Field.Store.NO);
        // ----------------------------------
        ...
        // ----------------------------------
        IntPoint fileSize = new IntPoint(Constants.filesize_int,(int) file.length());
        // ----------------------------------
        // //TODO IntPoint is not stored but we want to a file size
        // ... so add another field (StoredField) that stores file size
        // ----------------------------------
        StoredField fileSize2 = new StoredField(Constants.filesize,String.valueOf(file.length()));
        // ----------------------------------
